...
test_that('default arguments',
{
    ...
    expect_equal(testMod@timeIncrement, 0.000691, tolerance = 1e-3)
    ...
    expect_equal(testMod@maxDeformation, 0.1)
    expect_equal(testMod@maxTranslation, 0.1)
    expect_equal(testMod@maxRotation, 0.309, tolerance = 1e-3)
...
test_that('drasdo parameter calculations',
{
    ...
    expect_equal(testMod@maxDeformation, 0.2)
    expect_equal(testMod@maxTranslation, 0.2)
    expect_equal(testMod@maxRotation, 0.428, tolerance = 1e-3)
    expect_equal(testMod@timeIncrement, 0.00387, tolerance = 1e-3)
})
