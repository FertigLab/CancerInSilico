...
```{r}
plot(density(getGrowthRateDistribution(adv_case,1)))
plot(density(getGrowthRateDistribution(adv_case,200)))

mean(getGrowthRateDistribution(adv_case,1))
mean(getGrowthRateDistribution(adv_case,200))
```
