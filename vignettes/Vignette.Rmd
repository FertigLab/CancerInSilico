...
Density is also important in the cell model as a higher density will generally signify that a cell population has reached a possible critical point in which would be dangerous in a biological system.
```
# sample
library(CellModel)
