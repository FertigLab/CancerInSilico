...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type cellTypeDist(cellTypeDistSEXP);
    rcpp_result_gen = Rcpp::wrap(CellModel(initialNum, numMCSteps, density, maxTranslation, maxDeform, maxRotate, epsilon, delta, outIncrement, randSeed, drugEffect, growthRates, inheritGrowth, nG, timeIncrement, recordIncrement, drugTime, boundary, syncCellCycle, cellTypes, cellTypeDist));
